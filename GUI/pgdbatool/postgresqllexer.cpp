/***************************************************************************
                      postgresqllexer.cpp  -  description
                      ------------------------------------
...
// The ctor.
PostgreSQLLexer::PostgreSQLLexer(QObject *parent)
    : QsciLexer(parent),
...
const char *PostgreSQLLexer::language() const
{
    return "SQL";
}
...
const char *PostgreSQLLexer::lexer() const
{
    return "sql";
}
...
int PostgreSQLLexer::braceStyle() const
{
    return Operator;
}
...
QColor PostgreSQLLexer::defaultColor(int style) const
{
    switch (style)
    {
    case Default:
...
bool PostgreSQLLexer::defaultEolFill(int style) const
{
    if (style == PlusPrompt)
        return true;
...
QFont PostgreSQLLexer::defaultFont(int style) const
{
    QFont f;
...
const char *PostgreSQLLexer::keywords(int set) const
{
    if (set == 1)
        return
            ...
            "cast catalog check class clob close called "
            ...
            "leading left less level like limit local localtime leakproof listen "
            ...
            "session_user set sets size some space perform security "
            ...
            "user using value values variable "
    ...
    if (set == 4)
        return
            ...
            "sqlerror integer int varchar character varying "
            "interval text time timestamp date boolean decimal "
            "char record smallint float numeric void double precision "
            "float8 int4";
...
QString PostgreSQLLexer::description(int style) const
{
    switch (style)
    {
    case Default:
...
QColor PostgreSQLLexer::defaultPaper(int style) const
{
    if (style == PlusPrompt)
...
void PostgreSQLLexer::refreshProperties()
{
    setAtElseProp();
    setCommentProp();
    setCompactProp();
...
bool PostgreSQLLexer::readProperties(QSettings &qs, const QString &prefix)
{
    int rc = true;
...
bool PostgreSQLLexer::writeProperties(QSettings &qs, const QString &prefix) const
{
    int rc = true;
...
void PostgreSQLLexer::setFoldAtElse(bool fold)
{
    at_else = fold;
...
void PostgreSQLLexer::setAtElseProp()
{
...
void PostgreSQLLexer::setFoldComments(bool fold)
{
    fold_comments = fold;
...
void PostgreSQLLexer::setCommentProp()
{
...
void PostgreSQLLexer::setFoldCompact(bool fold)
{
    fold_compact = fold;
...
void PostgreSQLLexer::setCompactProp()
{
...
void PostgreSQLLexer::setFoldOnlyBegin(bool fold)
{
    only_begin = fold;
...
void PostgreSQLLexer::setOnlyBeginProp()
{
...
void PostgreSQLLexer::setQuotedIdentifiers(bool enable)
{
...
void PostgreSQLLexer::setBackticksIdentifierProp()
{
...
void PostgreSQLLexer::setHashComments(bool enable)
{
...
void PostgreSQLLexer::setNumbersignCommentProp()
{
...
void PostgreSQLLexer::setBackslashEscapes(bool enable)
{
...
void PostgreSQLLexer::setBackslashEscapesProp()
{
...
// Enable dotted words.
void PostgreSQLLexer::setDottedWords(bool enable)
{
...
void PostgreSQLLexer::setAllowDottedWordProp()
{

...
class QSCINTILLA_EXPORT PostgreSQLLexer : public QsciLexer
{
    Q_OBJECT
...
public:
    ...
    //! the QsciScintilla instance.
     PostgreSQLLexer(QObject *parent = 0);

    //! Destroys the QsciLexerSQL instance.
    virtual ~ PostgreSQLLexer();
...
private:
    ...
    PostgreSQLLexer(const PostgreSQLLexer &);
    PostgreSQLLexer &operator=(const PostgreSQLLexer &);
};
